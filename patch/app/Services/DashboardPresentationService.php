...
class DashboardPresentationService
{
    ...
    public function build(
        ...
        $recentTaskSessions = $this->recommendationService->recentTaskSessions($actorToken);
        $planTabs = $plans->map(function ($plan) use ($state, $actorToken, $previousSessions, $editablePlanIds, $recentTaskSessions) {
            ...
            $recommendation = $canEdit
                ? $this->recommendationService->recommend(
                    ...
                    recentTaskSessions: $recentTaskSessions,
                )
                : null;
