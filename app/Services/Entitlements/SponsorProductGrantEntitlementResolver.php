...
final class SponsorProductGrantEntitlementResolver implements EntitlementResolver
{
    ...
    {
        return EntitlementSource::Sponsor;
    }
    ...
    public function resolve(?User $actor, FeatureKey $feature, array $context = []): ?FeatureAccessDecision
    {
        ...
        $match = $this->grants->grantForFeature($actor, $feature, ['sponsor']);
        if (! $match) {
            return null;
        }
